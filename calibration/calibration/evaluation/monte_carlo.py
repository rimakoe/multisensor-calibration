...
if __name__ == "__main__":
    dataset_name = "C1L1_camera_special"
    reports = []
    ...
    plot_convergence(df=df, target="chi2_score", reference=report["chi2_score_center"], ylabel="$S_{\chi^2_n}$", config="mean")
    plot_convergence(df=df, target="robust_score", reference=1.0, ylabel="$S_R$", config="median")
